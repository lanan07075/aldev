...
public:
   ...
   WsfPlatform* GetPlatformBySign(WsfStringId aSignId) const;
...
private:
   ...
   //! The persistent list of platform sign ID's indexed by platform index.
   std::vector<WsfStringId> mPlatformSignIds;
   ...
   //! dawn
   //! The list of platforms indexed by platform sign(ID).
   std::map<WsfStringId, WsfPlatform*> mPlatformsBySign;
