...
//! dawn
// =================================================================================================
//! Return a pointer to a platform given the string ID of the platform sign.
//! @return A pointer to the platform or 0 if the platform does not exist.
WsfPlatform* WsfSimulation::GetPlatformBySign(WsfStringId aSignId) const
{
   WsfPlatform* platformPtr = nullptr;
   auto         iter        = mPlatformsBySign.find(aSignId);
   if (iter != mPlatformsBySign.end())
   {
...
void WsfSimulation::AddToPlatformList(WsfPlatform* aPlatformPtr)
{
   ...
   mPlatformsBySign[aPlatformPtr->GetSignId()] = aPlatformPtr;
   ...
   mPlatformSignIds.push_back(aPlatformPtr->GetSignId());
